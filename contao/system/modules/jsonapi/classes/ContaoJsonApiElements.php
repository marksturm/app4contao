...
class ContaoJsonApiElements
{
	...
	public function getTextElement($str_contentId,$arr_imgSize) {
		...
		$objOutput['text'] = ContaoJsonApiHelper::truncate($objTable->text,200);
		if($objTable->addImage) {
			$objOutput['picture'] = ContaoJsonApiHelper::image2json($objTable->singleSRC,$objTable->caption,$arr_imgSize);
		}
		return $objOutput;
	}
